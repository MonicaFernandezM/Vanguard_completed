...
* df\_exp\_clients → Asignación experimental (Control / Test)
* df\_web1 y df\_web2 → Eventos web (interacciones por visita)
* df\_demo → Información demográfica y financiera del cliente
...
* Construcción del dataset maestro (df\_master)
...
* Se rechaza H0: p\_test = p\_control
...
**Sara Leticia Marin Jauregui**

**Mónica Maria Fernandez Miras**
